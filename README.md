...
- <b>codebook.md</b> The codebook which describes the original data, the transformations made to it, and the output stored in <b>final_data.txt</b>. It contains the link to the original UCI HAR data set.
